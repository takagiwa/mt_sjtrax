...
#
# Generated by export_simulation on Tue Aug 02 10:24:41 +0900 2016
#
################################################################################
...
switch to the './vio_uart.sh' script.

./vio_uart.sh -reset_run
...
./vio_uart.sh -noclean_files

For more information on the script, please type './vio_uart.sh -help'.
