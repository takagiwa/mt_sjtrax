...
#
# Generated by export_simulation on Tue Aug 02 10:25:12 +0900 2016
#
################################################################################
...
switch to the './uartmon_fifo.sh' script.

./uartmon_fifo.sh -reset_run
...
./uartmon_fifo.sh -noclean_files

For more information on the script, please type './uartmon_fifo.sh -help'.
