...
#
# Generated by export_simulation on Tue Aug 02 10:26:04 +0900 2016
#
################################################################################
...
switch to the './ila_uartmon.sh' script.

./ila_uartmon.sh -reset_run
...
./ila_uartmon.sh -noclean_files

For more information on the script, please type './ila_uartmon.sh -help'.
