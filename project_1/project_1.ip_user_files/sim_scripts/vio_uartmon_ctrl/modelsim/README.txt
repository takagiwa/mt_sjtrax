...
#
# Generated by export_simulation on Tue Aug 02 10:25:30 +0900 2016
#
################################################################################
...
switch to the './vio_uartmon_ctrl.sh' script.

./vio_uartmon_ctrl.sh -reset_run
...
./vio_uartmon_ctrl.sh -noclean_files

For more information on the script, please type './vio_uartmon_ctrl.sh -help'.
