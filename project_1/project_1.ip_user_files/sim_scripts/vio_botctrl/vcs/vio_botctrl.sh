...
# executing this script. Please type 'vio_botctrl.sh -help' for more information.
#
...
reset_run()
{
  files_to_remove=(ucli.key vio_botctrl_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc vio_botctrl_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../project_1.srcs/sources_1/ip/vio_botctrl/sim/vio_botctrl.vhd" \
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.vio_botctrl -o vio_botctrl_simv
}
...
simulate()
{
  ...
  ./vio_botctrl_simv $opts -do simulate.do
}
# Script usage
usage()
{
