...
#
# Generated by export_simulation on Tue Aug 02 10:26:51 +0900 2016
#
################################################################################
...
switch to the './vio_botctrl.sh' script.

./vio_botctrl.sh -reset_run
...
./vio_botctrl.sh -noclean_files

For more information on the script, please type './vio_botctrl.sh -help'.
