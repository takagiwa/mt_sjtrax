...
#
# Generated by export_simulation on Tue Aug 02 10:24:22 +0900 2016
#
################################################################################
...
switch to the './uart_tx_fifo.sh' script.

./uart_tx_fifo.sh -reset_run
...
./uart_tx_fifo.sh -noclean_files

For more information on the script, please type './uart_tx_fifo.sh -help'.
