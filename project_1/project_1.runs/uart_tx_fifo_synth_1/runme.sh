...
HD_PWD='C:/Projects/sjtrax/project_1/project_1.runs/uart_tx_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_tx_fifo.vds -m64 -mode batch -messageDb vivado.pb -notrace -source uart_tx_fifo.tcl
