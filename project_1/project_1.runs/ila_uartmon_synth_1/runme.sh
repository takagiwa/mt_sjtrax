...
HD_PWD='C:/Projects/sjtrax/project_1/project_1.runs/ila_uartmon_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_uartmon.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ila_uartmon.tcl
