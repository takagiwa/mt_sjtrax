...
HD_PWD='C:/Projects/sjtrax/project_1/project_1.runs/map_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log map_mem.vds -m64 -mode batch -messageDb vivado.pb -notrace -source map_mem.tcl
