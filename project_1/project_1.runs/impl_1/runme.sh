...
HD_PWD='C:/Projects/sjtrax/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sjtrax.vdi -applog -m64 -messageDb vivado.pb -mode batch -source sjtrax.tcl -notrace
