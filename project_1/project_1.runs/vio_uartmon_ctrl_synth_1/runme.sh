...
HD_PWD='C:/Projects/sjtrax/project_1/project_1.runs/vio_uartmon_ctrl_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_uartmon_ctrl.vds -m64 -mode batch -messageDb vivado.pb -notrace -source vio_uartmon_ctrl.tcl
